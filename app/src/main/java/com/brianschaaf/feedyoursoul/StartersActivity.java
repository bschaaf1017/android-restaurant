...
public class StartersActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Dish[] apps = {
                ...
                new Dish("Mozz Sticks", "melted cheese", 1599),
                new Dish("Chicken Wings", "lemon pepper bone in, buffalo", 799)
        };


        ArrayAdapter<Dish> appAdapter = new ArrayAdapter<>(this, android.R.layout.simple_list_item_1, apps);

        startersList.setAdapter(appAdapter);
    }
